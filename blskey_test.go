...
var (
	...
	seed4, _ = new(big.Int).SetString("0xc55257c360c07c72029aebc1b53c05ed0362ada38ead3e3e9efa3708e53495531f09a6987599d18264c1e1c92f2cf141630c7a3c4ab7c81b2f001698e7463b04", 0)
	...
	master_SK4, _ = new(big.Int).SetString("6083874454709270928345386274498605044986640685124978867557563392430687146096", 10)

	child_SK0_0, _          = new(big.Int).SetString("20397789859736650942317412262472558107875392172444076792671091975210932703118", 10)
	child_SK1_3141592653, _ = new(big.Int).SetString("25457201688850691947727629385191704516744796114925897962676248250929345014287", 10)
	child_SK2_4294967295, _ = new(big.Int).SetString("29358610794459428860402234341874281240803786294062035874021252734817515685787", 10)
	child_SK3_42, _         = new(big.Int).SetString("31372231650479070279774297061823572166496564838472787488249775572789064611981", 10)
	child_SK4_0, _          = new(big.Int).SetString("20397789859736650942317412262472558107875392172444076792671091975210932703118", 10)
)
...
func TestKeyDerive(t *testing.T) {
	_doTestDerive(t, seed0, master_SK0, child_SK0_0, 0)
	_doTestDerive(t, seed1, master_SK1, child_SK1_3141592653, 3141592653)
	_doTestDerive(t, seed2, master_SK2, child_SK2_4294967295, 4294967295)
	_doTestDerive(t, seed3, master_SK3, child_SK3_42, 42)
	_doTestDerive(t, seed4, master_SK4, child_SK4_0, 0)
}
